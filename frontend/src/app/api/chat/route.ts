// POSTGRES_DB=neondb POSTGRES_HOST=ep-black-fog-a5nhv8so.us-east-2.aws.neon.tech POSTGRES_USER=neondb_read_only POSTGRES_PASSWORD=npg_Bq6Ncz2UPWXL POSTGRES_PORT=5432
...
export async function POST(request: NextRequest) {
  try {
    ...
    const stream = streamAgentReply(data.response.content); // stream token by token
